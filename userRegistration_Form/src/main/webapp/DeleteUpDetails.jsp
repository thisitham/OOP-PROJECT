...
<body translate="no">
	<%
	    ...
	    String rdate =request.getParameter("rdate1");
	    String rate =request.getParameter("rate1");
	    String cgory =request.getParameter("cgory1");
	    String lng =request.getParameter("lng1");
	    String dname =request.getParameter("dname1");
	    String descript =request.getParameter("descript1");
	    String upname =request.getParameter("upname1");
	    String upldt =request.getParameter("upldt1");
	%>
	<div id="shell">
			  <div id="header1">
				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <div class="top-row">
				            ...
				            <div class="field-wrap">
				              <label>
				                Release Date<span class="req">*</span>
				              </label>
				              <input type="text" name="rdate" value="<%= rdate%>" readonly/>
				            </div>
				          </div>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              ...
				              <input type="text" name="rate" value="<%= rate%>" readonly/>
				            </div>
				            ...
				            <div class="field-wrap">
				              ...
				              <input type="text" name="cgory" value="<%= cgory%>" readonly/>
				            </div>
				          </div>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              ...
				              <input type="text" name="lng" value="<%= lng%>" readonly/>
				            </div>
				            ...
				            <div class="field-wrap">
				              ...
				              <input type="text" name="dname" value="<%= dname%>" readonly/>
				            </div>
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <textarea type="text" name="descript"  rows="3" readonly><%= descript%></textarea>
				          ...
				          <div class="top-row">
				            <div class="field-wrap">
				              <label>
				                Uploader's Name<span class="req">*</span>
				              </label>
				              <input type="text" name="upname" value="<%= upname%>" readonly/>
				            </div>
				        
				            <div class="field-wrap">
				              <label>
				                Uploaded Date<span class="req">*</span>
				              </label>
				              <input type="text" name="upldt" value="<%= upldt%>" readonly/>
				            </div>
				          </div>
