				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="imdb" value="<%= imdb %>" readonly>				            
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="sesons" value="<%= sesons %>" readonly>				            
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="director" value="<%= director %>" readonly>				            
				          </div>
				          
				          <a>
				          	<button type="submit" class="button button-block">Delete TV Series</button>
				          </a>
