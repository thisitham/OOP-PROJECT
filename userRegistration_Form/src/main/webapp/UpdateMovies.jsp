				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="name" value="<%= movie_name %>">				            
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="type" value="<%= movie_type %>">				            
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="year" value="<%= movie_year %>">				            
				          </div>
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="rate" value="<%= movie_rate %>">				            
				          </div>
				          
				          <a>
				          	<button type="submit" class="button button-block">Update Movie Details</button>
				          </a>
