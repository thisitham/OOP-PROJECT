				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <div class="field-wrap">
				            <label>
				              Movie Id <span class="req">*</span>
				            </label>
				            <input type="text" name="movieid" value="<%= movie_id %>" readonly>
				          </div>				   
				          
				          <div class="field-wrap">
				            <label>
				              Movie Name <span class="req">*</span>
				            </label>
				            <input type="text" name="name" value="<%= movie_name %>" readonly>				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Movie Type <span class="req">*</span>
				            </label>
				            <input type="text" name="type" value="<%= movie_type %>" readonly>				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Movie Year <span class="req">*</span>
				            </label>
				            <input type="text" name="year" value="<%= movie_year %>" readonly>				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Movie Rate <span class="req">*</span>
				            </label>
				            <input type="text" name="rate" value="<%= movie_rate %>" readonly>				            
				          </div>
				          
				          <a>
				          	<button type="submit" class="button button-block">Delete Movie Details</button>
				          </a>
