	...
	<div id="shell">
			  ...
			  <div class="form">
			  	<a href="Selection.jsp">
			  		<center><button class="button button-block"/>TV SERIES</button></center>
			  	</a>
			  	
			  	<a href="Selection2.jsp">
			  		<center><button class="button button-block1"/>MOVIES</button></center>
			  	</a>
			  	
			  	<form action="updateMTservelet" method="post">
			  		<center><button class="button button-block2"/>UPLOADED CONTENTS</button></center>
			  	</form>
			  </div> <!-- /form -->
